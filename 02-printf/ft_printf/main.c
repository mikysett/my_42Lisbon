...
void	s_tester(void)
{
	...
	printf("\n");
	printf("16, %*.s %.1s ", 10, "123", "4567");
	printf("\n");
	printf("17, %*.0s %.2s ", 10, "123", "4567");
	printf("\n");
	printf("18, %*.3s %.3s ", 10, "123", "4567");
	printf("\n");
...
void	s_tester_ft(void)
{
	...
	printf("\n");
	ft_printf("16, %*.s %.1s ", 10, "123", "4567");
	printf("\n");
	ft_printf("17, %*.0s %.2s ", 10, "123", "4567");
	printf("\n");
	ft_printf("18, %*.3s %.3s ", 10, "123", "4567");
	printf("\n");
